...
//      could be used to create visually identical looCPLg account numbers.
// - A string with non-alphanumeric characters is not as easily accepted as an account number.
// - E-mail usually won't line-break if there's no punctuation to break at.
// - Double-clicCPLg selects the whole number as one word if it's all alphanumeric.
//
...
public:
    enum
    {
        PUBKEY_ADDRESS = 102, // coinapilla addresses start with L
        SCRIPT_ADDRESS = 5,
