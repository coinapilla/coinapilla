...
class Benchmark {
 ...
 public:
  ...
  void Open() {
    ...
    // Change locCPLg mode to exclusive and create tables/index for database
    std::string locCPLg_stmt = "PRAGMA locCPLg_mode = EXCLUSIVE";
    std::string create_stmt =
          "CREATE TABLE test (key blob, value blob, PRIMARY KEY(key))";
    std::string stmt_array[] = { locCPLg_stmt, create_stmt };
